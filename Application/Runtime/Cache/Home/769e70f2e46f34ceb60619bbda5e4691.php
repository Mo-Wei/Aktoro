                    ...
                    <div class="menu-menu-container">
                        <ul id="primary-menu" class="menu">
                            ...
                            <li id="menu-item-57" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-57">
                                <a href="/page/gustbook.html">留言</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="status_list_item icon_kyubo">
                        <div class="status_user" style="background-image: url(statics/images/b0ce3f3cde0c084b6d42321b2dcbc407.jpeg);">
                            <div class="status_section">
                                <a href="/page/detail_chudong.html" class="status_btn">初冬的味道</a>
                                <p class="section_p">
                                    立冬以后，乡野的味道立时就不同了。 走在乡间田野，土腥味不见了，那枯黄落叶的清香，各种草籽的熟香，以及村口烟囱里冒出来的草木灰的香，饭菜的淡淡幽香，是乡村特有的味道。这味道比繁花似锦的春日清淡，比浓荫匝地的夏日爽口，比萧瑟冷清的...
                                </p>
                            </div>
                        </div>
                    </div>
